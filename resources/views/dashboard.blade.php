                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Domicilio</th>
                  ...
                  <tbody>
                    <tr>
                        @foreach ($church_information as $key => $identificacion)
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $identificacion->domicilio }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs font-weight-bold mb-0">{{ $identificacion->fecha_nacimiento }}</p>
                            </td>
                            <td class="align-middle text-center">
                                <p class="text-xs font-weight-bold mb-0">{{ $identificacion->telefono }}</p>
                            </td>
                            <td class="align-middle text-center">
